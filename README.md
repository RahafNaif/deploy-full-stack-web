...
## Project overview:
This project is part of Full Stack Javascript Nanodegree course from Udacity.
It aims to practice deployment process for full stack web using amazon services RDS for database, S3 for frontend, and Elastic beanstalk for back-end api.

## Udagram Links:
- Frontend: http://udagram37698.s3-website-us-east-1.amazonaws.com/
- API: http://udagram-api-dev-last.eba-b8q85p9q.us-east-1.elasticbeanstalk.com/
